...
class IRBuilder {
  ...
  public:
    ...
    IBinaryInst *create_irem(Value *lhs, Value *rhs) {
    ...
    ICmpInst *create_and (Value *lhs, Value *rhs) {
        return ICmpInst::create_and(lhs, rhs, this->BB_);
    }
    ICmpInst *create_or (Value *lhs, Value *rhs) {
        return ICmpInst::create_or(lhs, rhs, this->BB_);
    }
