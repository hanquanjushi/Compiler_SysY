...
public:
  ...
  bool is_mod() const { return op_id_ == mod; }
  ...
  bool is_oror ()   const {return op_id_ == oror;}
  bool is_andand () const {return op_id_ == andand;}
...
public:
  ...
  static ICmpInst *create_and(Value *v1, Value *v2, BasicBlock *bb);
  static ICmpInst *create_or(Value *v1, Value *v2, BasicBlock *bb);
  virtual std::string print() override;
};
...
public:
  ...
  //static TruncInst *create_trunc_to_i1(Value *val, BasicBlock *bb);
