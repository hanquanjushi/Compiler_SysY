...
ICmpInst *ICmpInst::create_and( Value *v1, Value *v2, BasicBlock *bb)
{
    return create(andand, v1, v2, bb);
}
ICmpInst *ICmpInst::create_or( Value *v1, Value *v2, BasicBlock *bb)
{
    return create(oror, v1, v2, bb);
}
