...
label_entry:
  ...
  store i32  0, i32 * %op8
  br label %label9
label9:                                                ; preds = %label_entry, %label52
...
label16:                                                ; preds = %label9
  ...
  br i1  %op29, label %label31, label %label43
...
label31:                                                ; preds = %label16
  ...
  br i1  %op42, label %label53, label %label55
label43:                                                ; preds = %label16
  ...
  %op49 = icmp eq i32  %op48, -1
  %op50 = zext i1  %op49 to i32 
  %op51 = icmp ne i32  %op50, 0
  br i1  %op51, label %label56, label %label61
label52:                                                ; preds = %label55, %label61
  br label %label9
label53:                                                ; preds = %label31
  %op54 = load i32 , i32 * %op8
  ret i32  %op54
label55:                                                ; preds = %label31
  br label %label52
label56:                                                ; preds = %label43
