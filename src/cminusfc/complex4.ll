; ModuleID = 'cminus'
source_filename = "/home/hq/Test/2023ustc-jianmu-compiler/tests/2-ir-gen/autogen/testcases/lv3/complex4.cminus"
...
label_continue39:                                                ; preds = %label_continue37, %label_negative_index_38
  ...
  %op57 = getelementptr [3 x float], [3 x float]* %op1, i32 0, i32 0
  %op58 = getelementptr [12 x float], [12 x float]* %op2, i32 0, i32 0
  %op59 = getelementptr [12 x float], [12 x float]* %op2, i32 0, i32 0
  %op60 = call i32 @gauss(float* %op57, float* %op59, i32 3)
  store i32 0, i32* %op0
  br label %label_while_24
label_while_24:                                                ; preds = %label_continue39, %label_continue43
  %op61 = load i32, i32* %op0
  %op62 = icmp slt i32 %op61, 3
  br i1 %op62, label %label_true_25, label %label_false_26
label_true_25:                                                ; preds = %label_while_24
  %op63 = load i32, i32* %op0
  %op64 = icmp slt i32 %op63, 0
  br i1 %op64, label %label_negative_index_40, label %label_continue41
label_false_26:                                                ; preds = %label_while_24
  ret void
label_negative_index_40:                                                ; preds = %label_true_25
  call void @neg_idx_except()
  br label %label_continue41
label_continue41:                                                ; preds = %label_true_25, %label_negative_index_40
  %op65 = getelementptr [3 x float], [3 x float]* %op1, i32 0, i32 %op63
  %op66 = load i32, i32* %op0
  %op67 = icmp slt i32 %op66, 0
  br i1 %op67, label %label_negative_index_42, label %label_continue43
label_negative_index_42:                                                ; preds = %label_continue41
  call void @neg_idx_except()
  br label %label_continue43
label_continue43:                                                ; preds = %label_continue41, %label_negative_index_42
  %op68 = getelementptr [3 x float], [3 x float]* %op1, i32 0, i32 %op66
  %op69 = load float, float* %op68
  call void @outputFloat(float %op69)
